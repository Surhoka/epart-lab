export function getUserProfileMetaCardHtml() {
  return `
      ...
      <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
        <div class="flex flex-col items-center w-full gap-6 xl:flex-row">
          <div class="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
            <img src="../TailAdmin/public/images/user/owner.jpg" alt="user" />
          </div>
    ...
    <div id="edit-profile-modal" class="fixed inset-0 z-999999 flex items-center justify-center bg-black bg-opacity-50 hidden">
      <div class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        <button id="close-modal-button" class="absolute top-4 right-4 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
        ...
        <form class="flex flex-col">
          <div class="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
            <div>
              ...
              <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                <div>
                  <label class="mb-2.5 block text-sm font-medium text-gray-800 dark:text-white/90">Facebook</label>
                  <input
                    type="text"
                    value="https://www.facebook.com/PimjoHQ"
                    class="w-full rounded-lg border border-gray-200 bg-white px-5 py-3 text-gray-800 placeholder:text-gray-400 focus:border-brand-500 focus:outline-none dark:border-gray-800 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-gray-500 dark:focus:border-brand-500"
                  />
                </div>

                <div>
                  <label class="mb-2.5 block text-sm font-medium text-gray-800 dark:text-white/90">X.com</label>
                  <input type="text" value="https://x.com/PimjoHQ" class="w-full rounded-lg border border-gray-200 bg-white px-5 py-3 text-gray-800 placeholder:text-gray-400 focus:border-brand-500 focus:outline-none dark:border-gray-800 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-gray-500 dark:focus:border-brand-500" />
                </div>

                <div>
                  <label class="mb-2.5 block text-sm font-medium text-gray-800 dark:text-white/90">Linkedin</label>
                  <input
                    type="text"
                ...
                <div>
                  <label class="mb-2.5 block text-sm font-medium text-gray-800 dark:text-white/90">Instagram</label>
                  <input type="text" value="https://instagram.com/PimjoHQ" class="w-full rounded-lg border border-gray-200 bg-white px-5 py-3 text-gray-800 placeholder:text-gray-400 focus:border-brand-500 focus:outline-none dark:border-gray-800 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-gray-500 dark:focus:border-brand-500" />
                </div>
              </div>
            </div>
            <div class="mt-7">
          ...
          <div class="flex items-center gap-3 px-2 mt-6 lg:justify-end">
            <button id="close-modal-button-bottom" type="button" class="flex w-full items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200 lg:inline-flex lg:w-auto">
              Close
            </button>
...
export function initializeUserProfileMetaCard() {
  const editProfileButton = document.getElementById('edit-profile-button');
  const editProfileModal = document.getElementById('edit-profile-modal');
  const closeModalButton = document.getElementById('close-modal-button');
  const closeModalButtonBottom = document.getElementById('close-modal-button-bottom');
