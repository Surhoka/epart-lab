...
window.onload = function() {
  ...
  try { // Menambahkan try-catch di sekitar seluruh konten onload
    ...
    console.error("FATAL ERROR: Kesalahan di window.onload:", error);
    showMessageBox(`Terjadi kesalahan fatal: ${error.message}.`);
  }
};
