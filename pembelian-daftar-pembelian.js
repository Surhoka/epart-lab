...
if (typeof window.initPembelianDaftarPembelianPage === 'undefined') {
    window.initPembelianDaftarPembelianPage = function() {
        console.log('Memulai inisialisasi halaman Daftar Pembelian...');
        ...
        function initializePage() {
            ...
            console.log('Halaman Daftar Pembelian berhasil diinisialisasi.');
        }
