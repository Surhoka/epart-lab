                ...
                confirmInsertComicText() {
                    ...
                    const html = `
                        <div class="speech-bubble group/text ${balloonClass} ${tailClass}" data-id="${id}" data-panel-id="${panelId}" style="position: absolute; top: ${topCqi}cqi; left: calc(50% - ${widthCqi / 2}cqi); z-index: 20; min-width: 80px;" contenteditable="false">
                            ...
                            <div class="bubble-content comic-text-box" style="color: black; font-family: 'Outfit', sans-serif; font-weight: 500; line-height: calc(1.1 + 0.05); text-align: center; cursor: text; resize: both; overflow: hidden; width: ${widthCqi}cqi; height: auto; min-height: 2cqi; box-sizing: border-box; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                <div class="lang-id" contenteditable="true" style="display: block; width: 100%;">${textId}</div>
                                <div class="lang-en" contenteditable="true" style="display: none; width: 100%;">${textEn}</div>
                            </div>
                        </div>
                    `;
