...
<div class="rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03] flex flex-col">
  ...
  <div class="mb-4 flex justify-center">
    <div class="flex w-full items-center justify-center rounded-lg bg-gray-50 dark:bg-gray-800 h-48 overflow-hidden">
      ${item.FigureUrl ? `
        <img src="${item.FigureUrl}" alt="${item.Title}" class="w-full h-full object-contain rounded-lg" />
      ` : `
